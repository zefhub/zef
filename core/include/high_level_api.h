...
//             }
		...
		inline TimeSlice TimeSlice::operator() (ZefRef zr) const {
            return zr | to_ezefref | time_slice;
		}
		inline TimeSlice operator| (ZefRef zr, TimeSlice op) { return zefOps::time_slice(zr); }
	...
	namespace internals {
        ...
        inline EZefRefs all_raes(const Graph& graph) {
            ...
            return (blobs(graph)
                    | filter[BT.ENTITY_NODE, BT.ATOMIC_ENTITY_NODE, BT.RELATION_EDGE]
                    | filter[not_in][is_delegate_func]);
        }
...
//                                                |_____|              |___/                                        
    ...
    namespace imperative {
        ...
        inline Delegate delegate_rep(ZefRef zr) {
	...
	// One AET may accept various C++ types to be assigned. Hence, we define a predicate function to model this.
        ...
        template <typename T>
        LIBZEF_DLL_EXPORTED void assign_value(EZefRef my_atomic_entity, T value_to_be_assigned);
        template<> LIBZEF_DLL_EXPORTED void assign_value(EZefRef my_atomic_entity, bool value_to_be_assigned);
        template<> LIBZEF_DLL_EXPORTED void assign_value(EZefRef my_atomic_entity, int value_to_be_assigned);
        template<> LIBZEF_DLL_EXPORTED void assign_value(EZefRef my_atomic_entity, double value_to_be_assigned);
        template<> LIBZEF_DLL_EXPORTED void assign_value(EZefRef my_atomic_entity, str value_to_be_assigned);
        template<> LIBZEF_DLL_EXPORTED void assign_value(EZefRef my_atomic_entity, const char* value_to_be_assigned);
        template<> LIBZEF_DLL_EXPORTED void assign_value(EZefRef my_atomic_entity, Time value_to_be_assigned);
        template<> LIBZEF_DLL_EXPORTED void assign_value(EZefRef my_atomic_entity, SerializedValue value_to_be_assigned);
        template<> LIBZEF_DLL_EXPORTED void assign_value(EZefRef my_atomic_entity, ZefEnumValue value_to_be_assigned);
        template<> LIBZEF_DLL_EXPORTED void assign_value(EZefRef my_atomic_entity, QuantityFloat value_to_be_assigned);
        template<> LIBZEF_DLL_EXPORTED void assign_value(EZefRef my_atomic_entity, QuantityInt value_to_be_assigned);
        template<> LIBZEF_DLL_EXPORTED void assign_value(EZefRef my_atomic_entity, SerializedValue value_to_be_assigned);

        // when assigning values, it is always written to the tx opened at compute time, i.e. real time. One does not need the same operator API to address time as required for reading values
        template <typename T>
        inline void assign_value(ZefRef my_atomic_entity, T value_to_be_assigned) {
