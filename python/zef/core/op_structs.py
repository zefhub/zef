...
def is_supported_value(o):
    ...
    if isinstance(o, (set, range, ZefGenerator, GeneratorType, list, tuple, dict, ValueType, GraphSlice, Time, Image, Bytes, Error, Keyword, ModuleType, UserValueInstance, Delegate, Val, EntityValueInstance, ObjectInstance, RAE, QuantityFloat, QuantityInt)): return True
