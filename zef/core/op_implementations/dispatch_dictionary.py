...
_op_to_functions = {
        ...
        RT.Ins:             (ins_implementation, ins_type_info),
        RT.Outs:            (outs_implementation, outs_type_info),
        RT.InsAndOuts:      (ins_and_outs_implementation, ins_and_outs_type_info),
        ...
        RT.Out:             (Out_implementation, Out_type_info),
        RT.In:              (In_implementation, In_type_info),
        RT.OutOut:          (OutOut_implementation, OutOut_type_info),
        RT.InIn:            (InIn_implementation, InIn_type_info),
